...
# # recortamos la imagen alrededor de la palabra ej:"CARMEN"
# img_resized = ocr.recortar_imagen(bounds, "CARMEN", img_array, nueva_dimension=512)
# img_pil = Image.fromarray(img_resized)

# # # TD2 Inpaint
# result = simple_inpaint(img_pil, bounds, replace)
# stitched = ocr.stitch(result[0])
# ocr.display(stitched)